...
function db_resolve_can_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_can_message_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_lin_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_lin_message_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_flexray_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_flexray_message_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_ethernet_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_ethernet_pdu_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: ps32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
