...
function crypto_encrypt_aes128_ecb(key: pbyte; key_length: NativeUInt; plaintext: pbyte; plaintext_length: NativeUInt; ciphertext: pbyte; ciphertext_length: PNativeUInt): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function crypto_decrypt_aes128_ecb(key: pbyte; key_length: NativeUInt; ciphertext: pbyte; ciphertext_length: NativeUInt; plaintext: pbyte; plaintext_length: PNativeUInt): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
