...
{$ENDIF}
  ...
  TOnAutoSARPDUPreTxEvent = function(const AChnIdx: integer; const APDUName: PAnsichar; const AID: UInt32; const ASrcDataLength: UInt32; const ASrcSecuredDataLength: UInt32; const ASrcData: PByte; const AIsCopyToDestBuffer: PByte; const ADestDataLength: PUint32; const ADestData: PByte): integer; stdcall;
