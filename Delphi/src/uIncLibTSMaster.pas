...
const
  ...
  IDX_ERR_HW_API_PARAMETER_INVALID   = 41; // canonical spelling
  IDX_ERR_HW_API_PAEAMETER_INVALID   = 41; // legacy misspelled source alias
  ...
  IDX_ERR_UDS_REV_DATA_SHORT_THAN_EXPECTED          = 170;
  ...
  IDX_ERR_CAL_WRITE_DATA_FAILED                                = 431;
  IDX_ERR_CAL_READ_DATA_FAILED                                 = 432;
  IDX_ERR_MBD_AIFLOW_INVALID_CHART                             = 433;
  IDX_ERR_MBD_AIFLOW_NOT_FOUND                                 = 434;
  IDX_ERR_MBD_AIFLOW_INVALID_PARAM                             = 435;
  IDX_ERR_MBD_AIFLOW_NAME_EXISTS                               = 436;
  IDX_ERR_MBD_AIFLOW_INVALID_TYPE                              = 437;
  IDX_ERR_MBD_AIFLOW_INVALID_PARENT                            = 438;
  IDX_ERR_MBD_AIFLOW_CANNOT_DELETE                             = 439;
  IDX_ERR_MBD_AIFLOW_BUFFER_TOO_SMALL                          = 440;
  IDX_ERR_MBD_AIFLOW_NO_SELECTION                              = 441;
  IDX_ERR_MBD_AIFLOW_SERIALIZATION_FAILED                      = 442;
  IDX_ERR_MBD_AIFLOW_CONNECTION_FAILED                         = 443;
  IDX_ERR_MBD_AIFLOW_UI_NOT_AVAILABLE                          = 444;
  IDX_ERR_MBD_AIFLOW_NO_AIFLOW                                 = 445;
  IDX_ERR_MBD_AIFLOW_INTERNAL_ERROR                            = 446;
  IDX_ERR_MBD_AIFLOW_RESERVED1                                 = 447;
  IDX_ERR_MBD_AIFLOW_RESERVED2                                 = 448;
  IDX_ERR_MBD_AIFLOW_RESERVED3                                 = 449;
  IDX_ERR_MBD_AIFLOW_RESERVED4                                 = 450;
  IDX_ERR_MBD_AIFLOW_RESERVED5                                 = 451;
  IDX_ERR_MBD_AIFLOW_RESERVED6                                 = 452;
  IDX_ERR_MBD_AIFLOW_RESERVED7                                 = 453;
  IDX_ERR_HW_CAN_SEQ_TX_INVALID_HANDLE                         = 454;
  IDX_ERR_HW_CAN_SEQ_TX_CHN_NOT_READY                          = 455;
  IDX_ERR_HW_CAN_SEQ_TX_OUT_OF_RANGE                           = 456;
  IDX_ERR_LIN_FRAME_OVER_FLOW                                  = 457;
  IDX_ERR_LIN_SCHD_OVER_FLOW                                   = 458;
  IDX_ERR_LIN_RESERVED00                                       = 459;
  IDX_ERR_LIN_INVALID_FUNCTION_TYPE                            = 460;
  IDX_ERR_LIN_BAUDRATE_OUTOF_RANGE                             = 461;
  IDX_ERR_LIN_DIAG_IN_PROCESSING                               = 462;
  IDX_ERR_LIN_RESERVED001                                      = 463;
  IDX_ERR_LIN_NOT_SUPPORTED_IN_CUR_CONFIG                      = 464;
  IDX_ERR_NOT_SUPPORTED_IN_CUR_VERSION                         = 465;
  IDX_ERR_LIN_FRAME_NOT_EXISTS                                 = 466;
  IDX_ERR_LIN_RESERVED01                                       = 467;
  IDX_ERR_LIN_RESERVED02                                       = 468;
  IDX_ERR_LIN_RESERVED03                                       = 469;
  IDX_ERR_LIN_RESERVED04                                       = 470;
  IDX_ERR_LIN_RESERVED05                                       = 471;
  IDX_ERR_LIN_RESERVED06                                       = 472;
  IDX_ERR_LIN_RESERVED07                                       = 473;
  IDX_ERR_LIN_RESERVED08                                       = 474;
  IDX_ERR_LIN_RESERVED09                                       = 475;
  IDX_ERR_LIN_RESERVED10                                       = 476;
  IDX_ERR_MCP_PROVIDER_INVALID_ID                              = 477;
  IDX_ERR_MCP_PROVIDER_INVALID_HANDLER                         = 478;
  IDX_ERR_MCP_PROVIDER_ID_CONFLICT                             = 479;
  IDX_ERR_MCP_PROVIDER_HANDLER_MISMATCH                        = 480;
  IDX_ERR_MCP_PROVIDER_OWNER_UNRESOLVED                        = 481;
  IDX_ERR_MCP_PROVIDER_OWNER_MISMATCH                          = 482;
  IDX_ERR_MCP_PROVIDER_RUNTIME_NOT_READY                       = 483;
  IDX_ERR_MCP_PROVIDER_NOT_REGISTERED                          = 484;
  IDX_ERR_MCP_PROVIDER_AUTOLOAD_MAPPING_NOT_FOUND              = 485;
  IDX_ERR_MCP_PROVIDER_AUTOLOAD_MAPPING_INVALID                = 486;
  IDX_ERR_MCP_PROVIDER_LOAD_FAILED                             = 487;
  IDX_ERR_MCP_PROVIDER_LOAD_WAIT_TERMINATED                    = 488;
  IDX_ERR_MCP_PROVIDER_REGISTRATION_FAILED                     = 489;
  IDX_ERR_MCP_PROVIDER_REGISTRATION_MISSING_AFTER_LOAD         = 490;
  IDX_ERR_MCP_PROVIDER_LOADING                                 = 491;
  IDX_ERR_MCP_PROVIDER_UNLOADING                               = 492;
  IDX_ERR_MCP_PROVIDER_BUSY                                    = 493;
  IDX_ERR_MCP_PROVIDER_HANDLER_FAILED                          = 494;
  IDX_ERR_MCP_PROVIDER_UNLOAD_INDETERMINATE                    = 495;
  IDX_ERR_MEMORY_ALLOCATION_FAILED                             = 496;
  IDX_ERR_API_RETURN_VALUE_INVALID                             = 497;
  IDX_ERR_TARGET_RESOLUTION_AMBIGUOUS                          = 498;
  IDX_ERR_OUTPUT_BUFFER_TOO_SMALL                              = 499;
  IDX_ERR_NUMERIC_OVERFLOW                                     = 500;
  IDX_ERR_CONFIGURATION_PATH_INVALID                           = 501;
  ERR_CODE_COUNT                                               = 502;
...
function tsapp_set_auto_show_channel_mapping_window(const AEnable: Boolean): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function tsapp_configure_baudrate_lin(const AIdxChn: Integer; const ABaudrateKbps: Single; const AProtocol: Integer): Integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF} {Bps:such as 19200 bps}
...
function tscom_lin_rbs_enable(const AEnable: boolean): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function tsdiag_doip_set_version(const ADiagModuleIndex: integer; const AVersion: Integer): Integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function db_resolve_can_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_can_message_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_lin_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_lin_message_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_flexray_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_flexray_message_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_ethernet_signal_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function db_resolve_ethernet_pdu_address(const AAddress: PAnsiChar; const AIsTx: Boolean; AFullAddress: PAnsiChar; const AFullAddressCapacity: pint32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function can_rbs_activate_appointed_channel(const AChnIdx: int32; const AEnable: boolean; const AIncludingChildren: boolean): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function can_rbs_set_frame_data(const AChnIdx: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AMsgName: pansichar; const ADatas: pbyte; const ADataLength: int32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function can_rbs_get_frame_data(const AChnIdx: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AMsgName: pansichar; const ADatas: pbyte; const ADataLength: pInt32): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
...
function can_rbs_import_configuration(const AFileName: PAnsiChar): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function can_rbs_export_configuration(const AFileName: PAnsiChar): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function lin_rbs_import_configuration(const AFileName: PAnsiChar): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function lin_rbs_export_configuration(const AFileName: PAnsiChar): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
function flexray_rbs_import_configuration(const AFileName: PAnsiChar): integer; stdcall; {$IFNDEF LIBTSMASTER_IMPL} external DLL_LIB_TSMASTER; {$ENDIF}
