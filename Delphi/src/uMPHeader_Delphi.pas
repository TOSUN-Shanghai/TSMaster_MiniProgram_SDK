...
// TSMiniProgram C type definition =======================================================
  ...
  Tconfigure_canfd_regs_ex = function(const AChn: int32; const AArbBaudrateKbps: single; const AArbSEG1: uint32; const AArbSEG2: uint32; const AArbPrescaler: uint32; const AArbSJW: uint32; const ADataBaudrateKbps: single; const ADataSEG1: uint32; const ADataSEG2: uint32; const ADataPrescaler: uint32; const ADataSJW: uint32; const AControllerType: TLIBCANFDControllerType; const AControllerMode: TLIBCANFDControllerMode; const A120OhmConnected: boolean; const AOptions: PAnsiChar): s32; stdcall;
  ...
  Tset_di_channel_count = function(const ACount: int32): s32; stdcall;
  Tset_do_channel_count = function(const ACount: int32): s32; stdcall;
  Tset_ao_channel_count = function(const ACount: int32): s32; stdcall;
  Tset_ai_channel_count = function(const ACount: int32): s32; stdcall;
  Tget_ai_channel_count = function(const ACount: pInt32): s32; stdcall;
  ...
  Tregister_app_system_var_module = function(const AAppModuleName: pansichar): s32; stdcall;
  ...
  Tam_get_name_by_index = function(const AIndex: int32; AName: PPAnsiChar): s32; stdcall;
  Tam_get_sub_module_count = function(const AModuleName: PAnsichar; ACount: pInt32): s32; stdcall;
  Tam_get_sub_module_name_by_index = function(const AModuleName: PAnsichar; const AIndex: int32; ASubModuleName: PPAnsiChar; ADisplayName: PPAnsiChar): s32; stdcall;
  Tam_get_sub_module_info = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; AInfo: Pointer): s32; stdcall;
  Tam_find_sub_module = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; AIndex: pInt32): s32; stdcall;
  Tam_get_sub_module_running_state = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; AState: PLIBAutomationModuleRunningState): s32; stdcall;
  Tam_get_variant_group_count = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; ACount: pInt32): s32; stdcall;
  Tam_get_variant_group_name_by_index = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AIndex: int32; AGroupName: PPAnsiChar; AComment: PPAnsiChar; ASelected: PBoolean): s32; stdcall;
  Tam_add_variant_group = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AGroupName: PAnsichar; const AComment: PAnsichar): s32; stdcall;
  Tam_delete_variant_group = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AGroupName: PAnsichar): s32; stdcall;
  Tam_get_variant_count = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AGroupName: PAnsichar; ACount: pInt32): s32; stdcall;
  Tam_get_variant_by_index = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AGroupName: PAnsichar; const AIndex: int32; AArgName: PPAnsiChar; AArgValue: PPAnsiChar; AComment: PPAnsiChar): s32; stdcall;
  Tam_set_variant_value = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AGroupName: PAnsichar; const AArgName: PAnsichar; const AArgValue: PAnsichar): s32; stdcall;
  Tam_select_variant_group = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AGroupName: PAnsichar; const AIsSelect: boolean): s32; stdcall;
  Tam_get_local_var_count = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; ACount: pInt32): s32; stdcall;
  Tam_get_local_var_by_index = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AIndex: int32; AName: PPAnsiChar; AType: PLIBSimVarType; AInitValue: PPAnsiChar; AComment: PPAnsiChar): s32; stdcall;
  Tam_compile_current = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar): s32; stdcall;
  Tam_compile_all = function(const AModuleName: PAnsichar): s32; stdcall;
  Tam_pause = function(const AModuleName: PAnsichar): s32; stdcall;
  Tam_continue = function(const AModuleName: PAnsichar): s32; stdcall;
  Tam_step_over = function(const AModuleName: PAnsichar): s32; stdcall;
  Tam_step_into = function(const AModuleName: PAnsichar): s32; stdcall;
  Tam_get_progress = function(const AModuleName: PAnsichar; AProgress100: psingle): s32; stdcall;
  Tam_get_execution_result = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; AResult: pInt32): s32; stdcall;
  Tam_get_variant_group_result = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const AGroupName: PAnsichar; AResult: pInt32): s32; stdcall;
  Tam_run_all_checked = function(const AModuleName: PAnsichar; const AIsSync: boolean): s32; stdcall;
  Tam_run_all = function(const AModuleName: PAnsichar; const AIsSync: boolean): s32; stdcall;
  Tam_move_sub_module = function(const AModuleName: PAnsichar; const ASrcIndex: int32; const ADstIndex: int32): s32; stdcall;
  Tam_export_sub_module = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const ADestFileName: PAnsichar): s32; stdcall;
  Tam_export_sub_modules = function(const AModuleName: PAnsichar; const ASubModuleNames: PPAnsiChar; const ACount: int32; const ADestFileName: PAnsichar): s32; stdcall;
  Tam_import_sub_module = function(const AModuleName: PAnsichar; const ASrcFileName: PAnsichar; AImportedCount: pInt32; ALastImportedSubModuleName: PPAnsiChar): s32; stdcall;
  Tam_export_excel = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const ADestFileName: PAnsichar): s32; stdcall;
  Tam_import_excel = function(const AModuleName: PAnsichar; const ASrcFileName: PAnsichar; AImportedGraphicProgramName: PPAnsiChar; AImportedSubModuleName: PPAnsiChar): s32; stdcall;
  Tam_save_configuration = function(const AModuleName: PAnsichar; const ADestFileName: PAnsichar): s32; stdcall;
  Tam_load_configuration = function(const AModuleName: PAnsichar; const ASrcFileName: PAnsichar): s32; stdcall;
  Tam_get_current_log_dir = function(const AModuleName: PAnsichar; ALogDir: PPAnsiChar): s32; stdcall;
  Tam_get_overall_result = function(const AModuleName: PAnsichar; AResult: pInt32): s32; stdcall;
  Tam_clear_results = function(const AModuleName: PAnsichar): s32; stdcall;
  Tam_add_sub_module = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar; const ADisplayName: PAnsichar; ACreatedSubModuleName: PPAnsiChar): s32; stdcall;
  Tam_delete_sub_module = function(const AModuleName: PAnsichar; const ASubModuleName: PAnsichar): s32; stdcall;
  Tam_delete_all_sub_modules = function(const AModuleName: PAnsichar): s32; stdcall;
  ...
  Tgpg_begin_batch_import = function(): s32; stdcall;
  ...
  Ttsdo_set_pwm_output_async = function(const AChn: int32; ADuty: double; AFrequency: double): s32; stdcall;
  Ttsdo_set_vlevel_output_async = function(const AChn: int32; AIOStatus: int32): s32; stdcall;
  ...
  Tcal_add_xcp_ecu = function(const AECUName: pansichar; const AA2LFile: pansichar; const ATPLayer: int32; const AChnIdx: int32; const AEnabled: int32): s32; stdcall;
  ...
  Tcan_rbs_is_first_received_frame = function(const AChnIdx: int32; const ANetworkName: pansichar; const ANodeName: pansichar; const AFrameName: pansichar; const AIsFirstFrame: pInt32): s32; stdcall;
  Tcan_rbs_check_frame_undefined_bits_by_address = function(const AFrameAddress: pansichar; const AExpectedBit: byte; const AIsMatched: PBoolean): s32; stdcall;
  Tlin_rbs_check_frame_undefined_bits_by_address = function(const AFrameAddress: pansichar; const AExpectedBit: byte; const AIsMatched: PBoolean): s32; stdcall;
  Tflexray_rbs_check_frame_undefined_bits_by_address = function(const AFrameAddress: pansichar; const AExpectedBit: byte; const AIsMatched: PBoolean): s32; stdcall;
  Tethernet_rbs_check_pdu_undefined_bits_by_address = function(const APDUAddress: pansichar; const AExpectedBit: byte; const AIsMatched: PBoolean): s32; stdcall;
  Tcan_rbs_check_frame_trailing_undefined_bytes_by_address = function(const AFrameAddress: pansichar; const AExpectedByte: byte; const AIsMatched: PBoolean): s32; stdcall;
  ...
  Taiflow_get_chart_diagram = function(const ABlockId: int64; ADiagramSID: pint64): s32; stdcall;
  Taiflow_clear_chart = function(const ABlockId: int64): s32; stdcall;
  Taiflow_get_chart_name = function(const ABlockId: int64; AName: PPAnsiChar): s32; stdcall;
  Taiflow_set_chart_name = function(const ABlockId: int64; const AName: PAnsichar): s32; stdcall;
  Taiflow_get_chart_info = function(const ABlockId: int64; AName: PPAnsiChar; AObjectCount: pInt32; AStateCount: pInt32; ATransitionCount: pInt32): s32; stdcall;
  Taiflow_refresh_chart_ui = function(const ABlockId: int64): s32; stdcall;
  Taiflow_create_state = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_junction = function(const ABlockId: int64; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_transition = function(const ABlockId: int64; const ASourceSID: int64; const ATargetSID: int64; const ACondition: PAnsichar; const AAction: PAnsichar; ANewTransitionSID: pint64): s32; stdcall;
  Taiflow_create_group = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_graphic_function = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_c_function = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_truth_table = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_history_junction = function(const ABlockId: int64; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_comment = function(const ABlockId: int64; const AText: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_image = function(const ABlockId: int64; const AImagePath: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Taiflow_create_data = function(const ABlockId: int64; const AName: PAnsichar; const ADataType: PAnsichar; const AScope: PAnsichar; ANewSID: pint64): s32; stdcall;
  Taiflow_create_event = function(const ABlockId: int64; const AName: PAnsichar; const AScope: PAnsichar; ANewSID: pint64): s32; stdcall;
  Taiflow_delete_object_by_sid = function(const ABlockId: int64; const ASID: int64): s32; stdcall;
  Taiflow_delete_object_by_name = function(const ABlockId: int64; const AName: PAnsichar): s32; stdcall;
  Taiflow_delete_selected = function(const ABlockId: int64): s32; stdcall;
  Taiflow_find_object_by_name = function(const ABlockId: int64; const AName: PAnsichar; ASID: pint64): s32; stdcall;
  Taiflow_get_object_type = function(const ABlockId: int64; const ASID: int64; AType: PAiFlowObjectType): s32; stdcall;
  Taiflow_get_object_exists = function(const ABlockId: int64; const ASID: int64; AExists: pInt32): s32; stdcall;
  Taiflow_get_object_at_point = function(const ABlockId: int64; const AX: int32; const AY: int32; ASID: pint64): s32; stdcall;
  Taiflow_get_selected_count = function(const ABlockId: int64; ACount: pInt32): s32; stdcall;
  Taiflow_get_selected_sids = function(const ABlockId: int64; ASIDs: pint64; AMaxCount: pInt32): s32; stdcall;
  Taiflow_get_object_name = function(const ABlockId: int64; const ASID: int64; AName: PPAnsiChar): s32; stdcall;
  Taiflow_set_object_name = function(const ABlockId: int64; const ASID: int64; const ANewName: PAnsichar): s32; stdcall;
  Taiflow_get_object_bounds = function(const ABlockId: int64; const ASID: int64; ALeft: pInt32; ATop: pInt32; AWidth: pInt32; AHeight: pInt32): s32; stdcall;
  Taiflow_set_object_bounds = function(const ABlockId: int64; const ASID: int64; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32): s32; stdcall;
  Taiflow_get_object_selected = function(const ABlockId: int64; const ASID: int64; ASelected: pInt32): s32; stdcall;
  Taiflow_set_object_selected = function(const ABlockId: int64; const ASID: int64; const ASelected: int32): s32; stdcall;
  Taiflow_get_object_commented = function(const ABlockId: int64; const ASID: int64; ACommented: pInt32): s32; stdcall;
  Taiflow_set_object_commented = function(const ABlockId: int64; const ASID: int64; const ACommented: int32): s32; stdcall;
  Taiflow_get_object_locked = function(const ABlockId: int64; const ASID: int64; ALocked: pInt32): s32; stdcall;
  Taiflow_set_object_locked = function(const ABlockId: int64; const ASID: int64; const ALocked: int32): s32; stdcall;
  Taiflow_get_comment_text = function(const ABlockId: int64; const ACommentSID: int64; AText: PPAnsiChar): s32; stdcall;
  Taiflow_set_comment_text = function(const ABlockId: int64; const ACommentSID: int64; const AText: PAnsichar): s32; stdcall;
  Taiflow_get_data_type = function(const ABlockId: int64; const ADataSID: int64; ADataType: PPAnsiChar): s32; stdcall;
  Taiflow_set_data_type = function(const ABlockId: int64; const ADataSID: int64; const ADataType: PAnsichar): s32; stdcall;
  Taiflow_get_data_scope = function(const ABlockId: int64; const ADataSID: int64; AScope: PPAnsiChar): s32; stdcall;
  Taiflow_set_data_scope = function(const ABlockId: int64; const ADataSID: int64; const AScope: PAnsichar): s32; stdcall;
  Taiflow_get_state_label = function(const ABlockId: int64; const ASID: int64; ALabel: PPAnsiChar): s32; stdcall;
  Taiflow_set_state_label = function(const ABlockId: int64; const ASID: int64; const ALabel: PAnsichar): s32; stdcall;
  Taiflow_get_state_decomposition = function(const ABlockId: int64; const ASID: int64; ADecomposition: PAiFlowDecomposition): s32; stdcall;
  Taiflow_set_state_decomposition = function(const ABlockId: int64; const ASID: int64; const ADecomposition: TAiFlowDecomposition): s32; stdcall;
  Taiflow_get_transition_condition = function(const ABlockId: int64; const ATransitionSID: int64; ACondition: PPAnsiChar): s32; stdcall;
  Taiflow_set_transition_condition = function(const ABlockId: int64; const ATransitionSID: int64; const ACondition: PAnsichar): s32; stdcall;
  Taiflow_get_transition_action = function(const ABlockId: int64; const ATransitionSID: int64; AAction: PPAnsiChar): s32; stdcall;
  Taiflow_set_transition_action = function(const ABlockId: int64; const ATransitionSID: int64; const AAction: PAnsichar): s32; stdcall;
  Taiflow_get_transition_execution_order = function(const ABlockId: int64; const ATransitionSID: int64; AOrder: pInt32): s32; stdcall;
  Taiflow_set_transition_execution_order = function(const ABlockId: int64; const ATransitionSID: int64; const AOrder: int32): s32; stdcall;
  Taiflow_get_transition_breakpoint = function(const ABlockId: int64; const ATransitionSID: int64; ABreakpoint: pInt32): s32; stdcall;
  Taiflow_set_transition_breakpoint = function(const ABlockId: int64; const ATransitionSID: int64; const ABreakpoint: int32): s32; stdcall;
  Taiflow_get_state_entry_action = function(const ABlockId: int64; const AStateSID: int64; AAction: PPAnsiChar): s32; stdcall;
  Taiflow_set_state_entry_action = function(const ABlockId: int64; const AStateSID: int64; const AAction: PAnsichar): s32; stdcall;
  Taiflow_get_state_during_action = function(const ABlockId: int64; const AStateSID: int64; AAction: PPAnsiChar): s32; stdcall;
  Taiflow_set_state_during_action = function(const ABlockId: int64; const AStateSID: int64; const AAction: PAnsichar): s32; stdcall;
  Taiflow_get_state_exit_action = function(const ABlockId: int64; const AStateSID: int64; AAction: PPAnsiChar): s32; stdcall;
  Taiflow_set_state_exit_action = function(const ABlockId: int64; const AStateSID: int64; const AAction: PAnsichar): s32; stdcall;
  Taiflow_get_state_breakpoint = function(const ABlockId: int64; const AStateSID: int64; ABreakpoint: pInt32): s32; stdcall;
  Taiflow_set_state_breakpoint = function(const ABlockId: int64; const AStateSID: int64; const ABreakpoint: int32): s32; stdcall;
  Taiflow_get_junction_breakpoint = function(const ABlockId: int64; const AJunctionSID: int64; ABreakpoint: pInt32): s32; stdcall;
  Taiflow_set_junction_breakpoint = function(const ABlockId: int64; const AJunctionSID: int64; const ABreakpoint: int32): s32; stdcall;
  Taiflow_set_current_container = function(const ABlockId: int64; const AContainerSID: int64): s32; stdcall;
  Taiflow_get_current_container = function(const ABlockId: int64; AContainerSID: pint64): s32; stdcall;
  Taiflow_go_to_subchart = function(const ABlockId: int64; const AStateSID: int64): s32; stdcall;
  Taiflow_go_to_parent = function(const ABlockId: int64): s32; stdcall;
  Taiflow_connect_objects = function(const ABlockId: int64; const ASourceSID: int64; const ATargetSID: int64): s32; stdcall;
  Taiflow_disconnect_objects = function(const ABlockId: int64; const ASourceSID: int64; const ATargetSID: int64): s32; stdcall;
  Taiflow_get_transition_source = function(const ABlockId: int64; const ATransitionSID: int64; ASourceSID: pint64): s32; stdcall;
  Taiflow_get_transition_target = function(const ABlockId: int64; const ATransitionSID: int64; ATargetSID: pint64): s32; stdcall;
  Taiflow_get_object_transitions = function(const ABlockId: int64; const AObjectSID: int64; ATransitionSIDs: pint64; AMaxCount: pInt32): s32; stdcall;
  Taiflow_get_transition_count_between = function(const ABlockId: int64; const ASourceSID: int64; const ATargetSID: int64; ACount: pInt32): s32; stdcall;
  Taiflow_save_to_string = function(const ABlockId: int64; AData: PPAnsiChar): s32; stdcall;
  Taiflow_load_from_string = function(const ABlockId: int64; const AData: PAnsichar): s32; stdcall;
  Taiflow_clear_selections = function(const ABlockId: int64): s32; stdcall;
  Taiflow_select_all_objects = function(const ABlockId: int64): s32; stdcall;
  Taiflow_select_objects_by_type = function(const ABlockId: int64; const AType: TAiFlowObjectType): s32; stdcall;
  Taiflow_select_objects_in_rect = function(const ABlockId: int64; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32): s32; stdcall;
  Taiflow_invert_selection = function(const ABlockId: int64): s32; stdcall;
  Taiflow_fit_view = function(const ABlockId: int64): s32; stdcall;
  Taiflow_get_view_rect = function(const ABlockId: int64; ALeft: pInt32; ATop: pInt32; AWidth: pInt32; AHeight: pInt32): s32; stdcall;
  Taiflow_set_view_rect = function(const ABlockId: int64; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32): s32; stdcall;
  Taiflow_get_content_rect = function(const ABlockId: int64; ALeft: pInt32; ATop: pInt32; AWidth: pInt32; AHeight: pInt32): s32; stdcall;
  Taiflow_center_view_on_object = function(const ABlockId: int64; const AObjectSID: int64): s32; stdcall;
  Taiflow_enum_objects_by_type = function(const ABlockId: int64; const AType: TAiFlowObjectType; ASIDs: pint64; AMaxCount: pInt32): s32; stdcall;
  Taiflow_get_object_parent = function(const ABlockId: int64; const ASID: int64; AParentSID: pint64): s32; stdcall;
  ...
  TTSApp = packed record // C type
    ...
    set_di_channel_count: Tset_di_channel_count;
    set_do_channel_count: Tset_do_channel_count;
    set_ao_channel_count: Tset_ao_channel_count;
    set_ai_channel_count: Tset_ai_channel_count;
    get_ai_channel_count: Tget_ai_channel_count;
    ...
    register_app_system_var_module: Tregister_app_system_var_module;
    ...
    db_get_can_pdu_properties_by_index: Tdb_get_can_pdu_properties_by_index;
    ...
    am_get_name_by_index: Tam_get_name_by_index;
    am_get_sub_module_count: Tam_get_sub_module_count;
    am_get_sub_module_name_by_index: Tam_get_sub_module_name_by_index;
    am_get_sub_module_info: Tam_get_sub_module_info;
    am_find_sub_module: Tam_find_sub_module;
    am_get_sub_module_running_state: Tam_get_sub_module_running_state;
    am_get_variant_group_count: Tam_get_variant_group_count;
    am_get_variant_group_name_by_index: Tam_get_variant_group_name_by_index;
    am_add_variant_group: Tam_add_variant_group;
    am_delete_variant_group: Tam_delete_variant_group;
    am_get_variant_count: Tam_get_variant_count;
    am_get_variant_by_index: Tam_get_variant_by_index;
    am_set_variant_value: Tam_set_variant_value;
    am_select_variant_group: Tam_select_variant_group;
    am_get_local_var_count: Tam_get_local_var_count;
    am_get_local_var_by_index: Tam_get_local_var_by_index;
    am_compile_current: Tam_compile_current;
    am_compile_all: Tam_compile_all;
    am_pause: Tam_pause;
    am_continue: Tam_continue;
    am_step_over: Tam_step_over;
    am_step_into: Tam_step_into;
    am_get_progress: Tam_get_progress;
    am_get_execution_result: Tam_get_execution_result;
    am_get_variant_group_result: Tam_get_variant_group_result;
    am_run_all_checked: Tam_run_all_checked;
    am_run_all: Tam_run_all;
    am_move_sub_module: Tam_move_sub_module;
    am_export_sub_module: Tam_export_sub_module;
    am_export_sub_modules: Tam_export_sub_modules;
    am_import_sub_module: Tam_import_sub_module;
    am_export_excel: Tam_export_excel;
    am_import_excel: Tam_import_excel;
    am_save_configuration: Tam_save_configuration;
    am_load_configuration: Tam_load_configuration;
    am_get_current_log_dir: Tam_get_current_log_dir;
    am_get_overall_result: Tam_get_overall_result;
    am_clear_results: Tam_clear_results;
    am_add_sub_module: Tam_add_sub_module;
    am_delete_sub_module: Tam_delete_sub_module;
    am_delete_all_sub_modules: Tam_delete_all_sub_modules;
  ...
  TTSCOM = packed record // C type
    ...
    tsdo_set_pwm_output_async: Ttsdo_set_pwm_output_async;
    tsdo_set_vlevel_output_async: Ttsdo_set_vlevel_output_async;
    ...
    cal_add_xcp_ecu: Tcal_add_xcp_ecu;
    ...
    lin_rbs_check_frame_undefined_bits_by_address: Tlin_rbs_check_frame_undefined_bits_by_address;
    flexray_rbs_check_frame_undefined_bits_by_address: Tflexray_rbs_check_frame_undefined_bits_by_address;
    ethernet_rbs_check_pdu_undefined_bits_by_address: Tethernet_rbs_check_pdu_undefined_bits_by_address;
    can_rbs_check_frame_trailing_undefined_bytes_by_address: Tcan_rbs_check_frame_trailing_undefined_bytes_by_address;
  ...
  TTSMBD = packed record // C type
    ...
    aiflow_get_chart_diagram: Taiflow_get_chart_diagram;
    aiflow_clear_chart: Taiflow_clear_chart;
    aiflow_get_chart_name: Taiflow_get_chart_name;
    aiflow_set_chart_name: Taiflow_set_chart_name;
    aiflow_get_chart_info: Taiflow_get_chart_info;
    aiflow_refresh_chart_ui: Taiflow_refresh_chart_ui;
    aiflow_create_state: Taiflow_create_state;
    aiflow_create_junction: Taiflow_create_junction;
    aiflow_create_transition: Taiflow_create_transition;
    aiflow_create_group: Taiflow_create_group;
    aiflow_create_graphic_function: Taiflow_create_graphic_function;
    aiflow_create_c_function: Taiflow_create_c_function;
    aiflow_create_truth_table: Taiflow_create_truth_table;
    aiflow_create_history_junction: Taiflow_create_history_junction;
    aiflow_create_comment: Taiflow_create_comment;
    aiflow_create_image: Taiflow_create_image;
    aiflow_create_data: Taiflow_create_data;
    aiflow_create_event: Taiflow_create_event;
    aiflow_delete_object_by_sid: Taiflow_delete_object_by_sid;
    aiflow_delete_object_by_name: Taiflow_delete_object_by_name;
    aiflow_delete_selected: Taiflow_delete_selected;
    aiflow_find_object_by_name: Taiflow_find_object_by_name;
    aiflow_get_object_type: Taiflow_get_object_type;
    aiflow_get_object_exists: Taiflow_get_object_exists;
    aiflow_get_object_at_point: Taiflow_get_object_at_point;
    aiflow_get_selected_count: Taiflow_get_selected_count;
    aiflow_get_selected_sids: Taiflow_get_selected_sids;
    aiflow_get_object_name: Taiflow_get_object_name;
    aiflow_set_object_name: Taiflow_set_object_name;
    aiflow_get_object_bounds: Taiflow_get_object_bounds;
    aiflow_set_object_bounds: Taiflow_set_object_bounds;
    aiflow_get_object_selected: Taiflow_get_object_selected;
    aiflow_set_object_selected: Taiflow_set_object_selected;
    aiflow_get_object_commented: Taiflow_get_object_commented;
    aiflow_set_object_commented: Taiflow_set_object_commented;
    aiflow_get_object_locked: Taiflow_get_object_locked;
    aiflow_set_object_locked: Taiflow_set_object_locked;
    aiflow_get_comment_text: Taiflow_get_comment_text;
    aiflow_set_comment_text: Taiflow_set_comment_text;
    aiflow_get_data_type: Taiflow_get_data_type;
    aiflow_set_data_type: Taiflow_set_data_type;
    aiflow_get_data_scope: Taiflow_get_data_scope;
    aiflow_set_data_scope: Taiflow_set_data_scope;
    aiflow_get_state_label: Taiflow_get_state_label;
    aiflow_set_state_label: Taiflow_set_state_label;
    aiflow_get_state_decomposition: Taiflow_get_state_decomposition;
    aiflow_set_state_decomposition: Taiflow_set_state_decomposition;
    aiflow_get_transition_condition: Taiflow_get_transition_condition;
    aiflow_set_transition_condition: Taiflow_set_transition_condition;
    aiflow_get_transition_action: Taiflow_get_transition_action;
    aiflow_set_transition_action: Taiflow_set_transition_action;
    aiflow_get_transition_execution_order: Taiflow_get_transition_execution_order;
    aiflow_set_transition_execution_order: Taiflow_set_transition_execution_order;
    aiflow_get_transition_breakpoint: Taiflow_get_transition_breakpoint;
    aiflow_set_transition_breakpoint: Taiflow_set_transition_breakpoint;
    aiflow_get_state_entry_action: Taiflow_get_state_entry_action;
    aiflow_set_state_entry_action: Taiflow_set_state_entry_action;
    aiflow_get_state_during_action: Taiflow_get_state_during_action;
    aiflow_set_state_during_action: Taiflow_set_state_during_action;
    aiflow_get_state_exit_action: Taiflow_get_state_exit_action;
    aiflow_set_state_exit_action: Taiflow_set_state_exit_action;
    aiflow_get_state_breakpoint: Taiflow_get_state_breakpoint;
    aiflow_set_state_breakpoint: Taiflow_set_state_breakpoint;
    aiflow_get_junction_breakpoint: Taiflow_get_junction_breakpoint;
    aiflow_set_junction_breakpoint: Taiflow_set_junction_breakpoint;
    aiflow_set_current_container: Taiflow_set_current_container;
    aiflow_get_current_container: Taiflow_get_current_container;
    aiflow_go_to_subchart: Taiflow_go_to_subchart;
    aiflow_go_to_parent: Taiflow_go_to_parent;
    aiflow_connect_objects: Taiflow_connect_objects;
    aiflow_disconnect_objects: Taiflow_disconnect_objects;
    aiflow_get_transition_source: Taiflow_get_transition_source;
    aiflow_get_transition_target: Taiflow_get_transition_target;
    aiflow_get_object_transitions: Taiflow_get_object_transitions;
    aiflow_get_transition_count_between: Taiflow_get_transition_count_between;
    aiflow_save_to_string: Taiflow_save_to_string;
    aiflow_load_from_string: Taiflow_load_from_string;
    aiflow_clear_selections: Taiflow_clear_selections;
    aiflow_select_all_objects: Taiflow_select_all_objects;
    aiflow_select_objects_by_type: Taiflow_select_objects_by_type;
    aiflow_select_objects_in_rect: Taiflow_select_objects_in_rect;
    aiflow_invert_selection: Taiflow_invert_selection;
    aiflow_fit_view: Taiflow_fit_view;
    aiflow_get_view_rect: Taiflow_get_view_rect;
    aiflow_set_view_rect: Taiflow_set_view_rect;
    aiflow_get_content_rect: Taiflow_get_content_rect;
    aiflow_center_view_on_object: Taiflow_center_view_on_object;
    aiflow_enum_objects_by_type: Taiflow_enum_objects_by_type;
    aiflow_get_object_parent: Taiflow_get_object_parent;
