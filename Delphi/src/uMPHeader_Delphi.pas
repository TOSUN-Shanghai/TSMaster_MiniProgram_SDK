...
// TSMiniProgram C type definition =======================================================
  ...
  Tget_chart_aiflow_diagram = function(const ABlockId: int64; ADiagramSID: pint64): s32; stdcall;
  Tclear_chart_aiflow = function(const ABlockId: int64): s32; stdcall;
  Tget_chart_aiflow_name = function(const ABlockId: int64; AName: PPAnsiChar): s32; stdcall;
  Tset_chart_aiflow_name = function(const ABlockId: int64; const AName: PAnsichar): s32; stdcall;
  Tget_chart_aiflow_info = function(const ABlockId: int64; AName: PPAnsiChar; AObjectCount: pInt32; AStateCount: pInt32; ATransitionCount: pInt32): s32; stdcall;
  Trefresh_chart_aiflow_ui = function(const ABlockId: int64): s32; stdcall;
  Tcreate_aiflow_state = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_junction = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_transition = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; const ACondition: PAnsichar; const AAction: PAnsichar; ANewTransitionSID: pint64): s32; stdcall;
  Tcreate_aiflow_group = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_graphic_function = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_c_function = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_truth_table = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_history_junction = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_comment = function(const ABlockId: int64; const AText: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_data = function(const ABlockId: int64; const AName: PAnsichar; const ADataType: PAnsichar; const AScope: PAnsichar; ANewSID: pint64): s32; stdcall;
  Tcreate_aiflow_event = function(const ABlockId: int64; const AName: PAnsichar; const AScope: PAnsichar; ANewSID: pint64): s32; stdcall;
  Tdelete_aiflow_object_by_name = function(const ABlockId: int64; const AName: PAnsichar): s32; stdcall;
  Tdelete_aiflow_object_by_sid = function(const ABlockId: int64; const ASID: int64): s32; stdcall;
  Tdelete_aiflow_selected = function(const ABlockId: int64): s32; stdcall;
  Tfind_aiflow_object_by_name = function(const ABlockId: int64; const AName: PAnsichar; ASID: pint64): s32; stdcall;
  Tget_aiflow_object_type = function(const ABlockId: int64; const AName: PAnsichar; AType: PAiFlowObjectType): s32; stdcall;
  Tget_aiflow_object_exists = function(const ABlockId: int64; const AName: PAnsichar; AExists: pInt32): s32; stdcall;
  Tget_aiflow_object_at_point = function(const ABlockId: int64; const AX: int32; const AY: int32; AName: PPAnsiChar; ASID: pint64): s32; stdcall;
  Tget_aiflow_selected_count = function(const ABlockId: int64; ACount: pInt32): s32; stdcall;
  Tget_aiflow_selected_sids = function(const ABlockId: int64; ASIDs: pint64; AMaxCount: pInt32): s32; stdcall;
  Tget_aiflow_selected_names = function(const ABlockId: int64; ANames: PPAnsiChar; AMaxCount: pInt32): s32; stdcall;
  Tget_aiflow_object_name = function(const ABlockId: int64; const ASID: int64; AName: PPAnsiChar): s32; stdcall;
  Tset_aiflow_object_name = function(const ABlockId: int64; const AOldName: PAnsichar; const ANewName: PAnsichar): s32; stdcall;
  Tget_aiflow_object_bounds = function(const ABlockId: int64; const AName: PAnsichar; ALeft: pInt32; ATop: pInt32; AWidth: pInt32; AHeight: pInt32): s32; stdcall;
  Tset_aiflow_object_bounds = function(const ABlockId: int64; const AName: PAnsichar; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32): s32; stdcall;
  Tget_aiflow_object_selected = function(const ABlockId: int64; const AName: PAnsichar; ASelected: pInt32): s32; stdcall;
  Tset_aiflow_object_selected = function(const ABlockId: int64; const AName: PAnsichar; const ASelected: int32): s32; stdcall;
  Tget_aiflow_object_commented = function(const ABlockId: int64; const AName: PAnsichar; ACommented: pInt32): s32; stdcall;
  Tset_aiflow_object_commented = function(const ABlockId: int64; const AName: PAnsichar; const ACommented: int32): s32; stdcall;
  Tget_state_label = function(const ABlockId: int64; const AName: PAnsichar; ALabel: PPAnsiChar): s32; stdcall;
  Tset_state_label = function(const ABlockId: int64; const AName: PAnsichar; const ALabel: PAnsichar): s32; stdcall;
  Tget_state_decomposition = function(const ABlockId: int64; const AName: PAnsichar; ADecomposition: PAiFlowDecomposition): s32; stdcall;
  Tset_state_decomposition = function(const ABlockId: int64; const AName: PAnsichar; const ADecomposition: TAiFlowDecomposition): s32; stdcall;
  Tget_transition_condition = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; ACondition: PPAnsiChar): s32; stdcall;
  Tset_transition_condition = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; const ACondition: PAnsichar): s32; stdcall;
  Tget_transition_action = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; AAction: PPAnsiChar): s32; stdcall;
  Tset_transition_action = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; const AAction: PAnsichar): s32; stdcall;
  Tget_transition_execution_order = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; AOrder: pInt32): s32; stdcall;
  Tset_transition_execution_order = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; const AOrder: int32): s32; stdcall;
  Tget_transition_condition_by_sid = function(const ABlockId: int64; const ATransitionSID: int64; ACondition: PPAnsiChar): s32; stdcall;
  Tset_transition_condition_by_sid = function(const ABlockId: int64; const ATransitionSID: int64; const ACondition: PAnsichar): s32; stdcall;
  Tget_transition_action_by_sid = function(const ABlockId: int64; const ATransitionSID: int64; AAction: PPAnsiChar): s32; stdcall;
  Tset_transition_action_by_sid = function(const ABlockId: int64; const ATransitionSID: int64; const AAction: PAnsichar): s32; stdcall;
  Tget_transition_execution_order_by_sid = function(const ABlockId: int64; const ATransitionSID: int64; AOrder: pInt32): s32; stdcall;
  Tset_transition_execution_order_by_sid = function(const ABlockId: int64; const ATransitionSID: int64; const AOrder: int32): s32; stdcall;
  Tdisconnect_transition_by_sid = function(const ABlockId: int64; const ATransitionSID: int64): s32; stdcall;
  Tset_transition_breakpoint_by_sid = function(const ABlockId: int64; const ATransitionSID: int64; const ABreakpoint: int32): s32; stdcall;
  Tset_aiflow_current_container = function(const ABlockId: int64; const AContainerName: PAnsichar): s32; stdcall;
  Tget_aiflow_current_container = function(const ABlockId: int64; AContainerName: PPAnsiChar): s32; stdcall;
  Tgo_to_aiflow_subchart = function(const ABlockId: int64; const AStateName: PAnsichar): s32; stdcall;
  Tgo_to_aiflow_parent = function(const ABlockId: int64): s32; stdcall;
  Tconnect_aiflow_objects = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar): s32; stdcall;
  Tdisconnect_aiflow_objects = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar): s32; stdcall;
  Tget_transition_source = function(const ABlockId: int64; const ATransitionSID: int64; ASourceName: PPAnsiChar; ASourceSID: pint64): s32; stdcall;
  Tget_transition_target = function(const ABlockId: int64; const ATransitionSID: int64; ATargetName: PPAnsiChar; ATargetSID: pint64): s32; stdcall;
  Tget_object_transitions = function(const ABlockId: int64; const AObjectName: PAnsichar; ATransitionSIDs: pint64; AMaxCount: pInt32): s32; stdcall;
  Tsave_aiflow_to_string = function(const ABlockId: int64; AData: PPAnsiChar): s32; stdcall;
  Tload_aiflow_from_string = function(const ABlockId: int64; const AData: PAnsichar): s32; stdcall;
  Tcopy_aiflow_selection = function(const ABlockId: int64; AClipboardData: PPAnsiChar): s32; stdcall;
  Tpaste_aiflow_clipboard = function(const ABlockId: int64; const AClipboardData: PAnsichar; const AOffsetX: int32; const AOffsetY: int32): s32; stdcall;
  Tset_aiflow_breakpoint = function(const ABlockId: int64; const AObjectName: PAnsichar; const ABreakOnEntry: int32; const ABreakOnExit: int32): s32; stdcall;
  Tget_aiflow_breakpoint = function(const ABlockId: int64; const AObjectName: PAnsichar; ABreakOnEntry: pInt32; ABreakOnExit: pInt32): s32; stdcall;
  Tenable_aiflow_breakpoint = function(const ABlockId: int64; const AObjectName: PAnsichar; const AEnabled: int32): s32; stdcall;
  Tclear_all_aiflow_breakpoints = function(const ABlockId: int64): s32; stdcall;
  Tget_aiflow_breakpoint_list = function(const ABlockId: int64; AObjectNames: PPAnsiChar; AMaxCount: pInt32): s32; stdcall;
  Tset_transition_breakpoint = function(const ABlockId: int64; const ASourceName: PAnsichar; const ATargetName: PAnsichar; const ABreakpoint: int32): s32; stdcall;
  Tclear_aiflow_selections = function(const ABlockId: int64): s32; stdcall;
  Tselect_all_aiflow_objects = function(const ABlockId: int64): s32; stdcall;
  Tselect_aiflow_objects_by_type = function(const ABlockId: int64; const AType: TAiFlowObjectType): s32; stdcall;
  Tselect_aiflow_objects_in_rect = function(const ABlockId: int64; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32): s32; stdcall;
  Tinvert_aiflow_selection = function(const ABlockId: int64): s32; stdcall;
  Tfit_aiflow_view = function(const ABlockId: int64): s32; stdcall;
  Tget_aiflow_view_rect = function(const ABlockId: int64; ALeft: pInt32; ATop: pInt32; AWidth: pInt32; AHeight: pInt32): s32; stdcall;
  Tset_aiflow_view_rect = function(const ABlockId: int64; const ALeft: int32; const ATop: int32; const AWidth: int32; const AHeight: int32): s32; stdcall;
  Tget_aiflow_content_rect = function(const ABlockId: int64; ALeft: pInt32; ATop: pInt32; AWidth: pInt32; AHeight: pInt32): s32; stdcall;
  Tcenter_aiflow_view_on_object = function(const ABlockId: int64; const AObjectName: PAnsichar): s32; stdcall;
  Tundo_aiflow = function(const ABlockId: int64): s32; stdcall;
  Tredo_aiflow = function(const ABlockId: int64): s32; stdcall;
  Tmove_aiflow_objects = function(const ABlockId: int64; const ADeltaX: int32; const ADeltaY: int32): s32; stdcall;
  Tresize_aiflow_object = function(const ABlockId: int64; const AObjectName: PAnsichar; const ANewWidth: int32; const ANewHeight: int32): s32; stdcall;
  Tcomment_aiflow_selected = function(const ABlockId: int64; const AComment: int32): s32; stdcall;
  Talign_aiflow_objects = function(const ABlockId: int64; const AAlignMode: TAiFlowAlignMode): s32; stdcall;
  Tget_unique_aiflow_name = function(const ABlockId: int64; const ASuggestedName: PAnsichar; AUniqueName: PPAnsiChar): s32; stdcall;
  Tvalidate_aiflow_name = function(const ABlockId: int64; const AName: PAnsichar; AValid: pInt32): s32; stdcall;
  Tget_aiflow_name_suggestions = function(const ABlockId: int64; const ABaseName: PAnsichar; ASuggestions: PPAnsiChar; AMaxCount: pInt32): s32; stdcall;
  Trename_aiflow_objects_batch = function(const ABlockId: int64; const APattern: PAnsichar; const AStartIndex: int32): s32; stdcall;
  Tget_aiflow_object_count = function(const ABlockId: int64; ACount: pInt32): s32; stdcall;
  Tget_aiflow_object_by_index = function(const ABlockId: int64; const AIndex: int32; AName: PPAnsiChar; ASID: pint64; AType: PAiFlowObjectType): s32; stdcall;
  Tenum_aiflow_objects_by_type = function(const ABlockId: int64; const AType: TAiFlowObjectType; ASIDs: pint64; AMaxCount: pInt32): s32; stdcall;
  Tget_aiflow_state_count = function(const ABlockId: int64; ACount: pInt32): s32; stdcall;
  Tget_aiflow_transition_count = function(const ABlockId: int64; ACount: pInt32): s32; stdcall;
  Tget_aiflow_junction_count = function(const ABlockId: int64; ACount: pInt32): s32; stdcall;
  ...
  TTSMBD = packed record // C type
    ...
    get_chart_aiflow_diagram: Tget_chart_aiflow_diagram;
    clear_chart_aiflow: Tclear_chart_aiflow;
    get_chart_aiflow_name: Tget_chart_aiflow_name;
    set_chart_aiflow_name: Tset_chart_aiflow_name;
    get_chart_aiflow_info: Tget_chart_aiflow_info;
    refresh_chart_aiflow_ui: Trefresh_chart_aiflow_ui;
    create_aiflow_state: Tcreate_aiflow_state;
    create_aiflow_junction: Tcreate_aiflow_junction;
    create_aiflow_transition: Tcreate_aiflow_transition;
    create_aiflow_group: Tcreate_aiflow_group;
    create_aiflow_graphic_function: Tcreate_aiflow_graphic_function;
    create_aiflow_c_function: Tcreate_aiflow_c_function;
    create_aiflow_truth_table: Tcreate_aiflow_truth_table;
    create_aiflow_history_junction: Tcreate_aiflow_history_junction;
    create_aiflow_comment: Tcreate_aiflow_comment;
    create_aiflow_data: Tcreate_aiflow_data;
    create_aiflow_event: Tcreate_aiflow_event;
    delete_aiflow_object_by_name: Tdelete_aiflow_object_by_name;
    delete_aiflow_object_by_sid: Tdelete_aiflow_object_by_sid;
    delete_aiflow_selected: Tdelete_aiflow_selected;
    find_aiflow_object_by_name: Tfind_aiflow_object_by_name;
    get_aiflow_object_type: Tget_aiflow_object_type;
    get_aiflow_object_exists: Tget_aiflow_object_exists;
    get_aiflow_object_at_point: Tget_aiflow_object_at_point;
    get_aiflow_selected_count: Tget_aiflow_selected_count;
    get_aiflow_selected_sids: Tget_aiflow_selected_sids;
    get_aiflow_selected_names: Tget_aiflow_selected_names;
    get_aiflow_object_name: Tget_aiflow_object_name;
    set_aiflow_object_name: Tset_aiflow_object_name;
    get_aiflow_object_bounds: Tget_aiflow_object_bounds;
    set_aiflow_object_bounds: Tset_aiflow_object_bounds;
    get_aiflow_object_selected: Tget_aiflow_object_selected;
    set_aiflow_object_selected: Tset_aiflow_object_selected;
    get_aiflow_object_commented: Tget_aiflow_object_commented;
    set_aiflow_object_commented: Tset_aiflow_object_commented;
    get_state_label: Tget_state_label;
    set_state_label: Tset_state_label;
    get_state_decomposition: Tget_state_decomposition;
    set_state_decomposition: Tset_state_decomposition;
    get_transition_condition: Tget_transition_condition;
    set_transition_condition: Tset_transition_condition;
    get_transition_action: Tget_transition_action;
    set_transition_action: Tset_transition_action;
    get_transition_execution_order: Tget_transition_execution_order;
    set_transition_execution_order: Tset_transition_execution_order;
    get_transition_condition_by_sid: Tget_transition_condition_by_sid;
    set_transition_condition_by_sid: Tset_transition_condition_by_sid;
    get_transition_action_by_sid: Tget_transition_action_by_sid;
    set_transition_action_by_sid: Tset_transition_action_by_sid;
    get_transition_execution_order_by_sid: Tget_transition_execution_order_by_sid;
    set_transition_execution_order_by_sid: Tset_transition_execution_order_by_sid;
    disconnect_transition_by_sid: Tdisconnect_transition_by_sid;
    set_transition_breakpoint_by_sid: Tset_transition_breakpoint_by_sid;
    set_aiflow_current_container: Tset_aiflow_current_container;
    get_aiflow_current_container: Tget_aiflow_current_container;
    go_to_aiflow_subchart: Tgo_to_aiflow_subchart;
    go_to_aiflow_parent: Tgo_to_aiflow_parent;
    connect_aiflow_objects: Tconnect_aiflow_objects;
    disconnect_aiflow_objects: Tdisconnect_aiflow_objects;
    get_transition_source: Tget_transition_source;
    get_transition_target: Tget_transition_target;
    get_object_transitions: Tget_object_transitions;
    save_aiflow_to_string: Tsave_aiflow_to_string;
    load_aiflow_from_string: Tload_aiflow_from_string;
    copy_aiflow_selection: Tcopy_aiflow_selection;
    paste_aiflow_clipboard: Tpaste_aiflow_clipboard;
    set_aiflow_breakpoint: Tset_aiflow_breakpoint;
    get_aiflow_breakpoint: Tget_aiflow_breakpoint;
    enable_aiflow_breakpoint: Tenable_aiflow_breakpoint;
    clear_all_aiflow_breakpoints: Tclear_all_aiflow_breakpoints;
    get_aiflow_breakpoint_list: Tget_aiflow_breakpoint_list;
    set_transition_breakpoint: Tset_transition_breakpoint;
    clear_aiflow_selections: Tclear_aiflow_selections;
    select_all_aiflow_objects: Tselect_all_aiflow_objects;
    select_aiflow_objects_by_type: Tselect_aiflow_objects_by_type;
    select_aiflow_objects_in_rect: Tselect_aiflow_objects_in_rect;
    invert_aiflow_selection: Tinvert_aiflow_selection;
    fit_aiflow_view: Tfit_aiflow_view;
    get_aiflow_view_rect: Tget_aiflow_view_rect;
    set_aiflow_view_rect: Tset_aiflow_view_rect;
    get_aiflow_content_rect: Tget_aiflow_content_rect;
    center_aiflow_view_on_object: Tcenter_aiflow_view_on_object;
    undo_aiflow: Tundo_aiflow;
    redo_aiflow: Tredo_aiflow;
    move_aiflow_objects: Tmove_aiflow_objects;
    resize_aiflow_object: Tresize_aiflow_object;
    comment_aiflow_selected: Tcomment_aiflow_selected;
    align_aiflow_objects: Talign_aiflow_objects;
    get_unique_aiflow_name: Tget_unique_aiflow_name;
    validate_aiflow_name: Tvalidate_aiflow_name;
    get_aiflow_name_suggestions: Tget_aiflow_name_suggestions;
    rename_aiflow_objects_batch: Trename_aiflow_objects_batch;
    get_aiflow_object_count: Tget_aiflow_object_count;
    get_aiflow_object_by_index: Tget_aiflow_object_by_index;
    enum_aiflow_objects_by_type: Tenum_aiflow_objects_by_type;
    get_aiflow_state_count: Tget_aiflow_state_count;
    get_aiflow_transition_count: Tget_aiflow_transition_count;
    get_aiflow_junction_count: Tget_aiflow_junction_count;
    FDummy: array [0..634-1] of NativeInt; // place holders, TS_MBD_PROTO_END
  end;
  PTSMBD = ^TTSMBD;
